...
export default function Monitor() {
  ...
  const [ailive, setAilive] = useState<any>(null);
  ...
  return (
    <>
      {liveon && (
        <Card className="w-[90vw] mx-auto mt-10 min-h-[20vh] shadow-md">
          <CardContent>
            <div className="flex justify-center items-center font-semibold">
              {!ailive ? <Spinner /> : ailive.completion}
            </div>
          </CardContent>
        </Card>
      )}
            ...
            <div className="text-2xl flex flex-col mb-5">
              ...
              <div className="flex justify-center mt-2 gap-2">
                ...
                {/* {liveon ? (
                  ...
                  <Button className="" onClick={startLiveUpdates}>
                    LIVE OFF
                  </Button>
                )} */}
              </div>
